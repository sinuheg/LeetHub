<h2><a href="https://leetcode.com/problems/distance-to-a-cycle-in-undirected-graph">2204. Distance to a Cycle in Undirected Graph</a></h2><h3>Hard</h3><hr><p>You are given a positive integer <code>n</code> representing the number of nodes in a <strong>connected undirected graph</strong> containing <strong>exactly one</strong> cycle. The nodes are numbered from <code>0</code> to <code>n - 1</code> (<strong>inclusive</strong>).</p>
